...
class CredentialsGetCredential {
  /// Returns a new [CredentialsGetCredential] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is CredentialsGetCredential &&
          other.uuid == uuid &&
  ...
  /// Returns a new [CredentialsGetCredential] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CredentialsGetCredential? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CredentialsGetCredential[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CredentialsGetCredential[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CredentialsGetCredential(
  ...
  static List<CredentialsGetCredential> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <CredentialsGetCredential>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CredentialsGetCredential.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CredentialsGetCredential> mapFromJson(dynamic json) {
    final map = <String, CredentialsGetCredential>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CredentialsGetCredential.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CredentialsGetCredential-objects as value to a dart map
  static Map<String, List<CredentialsGetCredential>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<CredentialsGetCredential>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CredentialsGetCredential.listFromJson(
          entry.value,
          growable: growable,
        );
      }
