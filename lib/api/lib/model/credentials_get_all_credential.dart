...
class CredentialsGetAllCredential {
  /// Returns a new [CredentialsGetAllCredential] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is CredentialsGetAllCredential &&
          other.uuid == uuid &&
  ...
  /// Returns a new [CredentialsGetAllCredential] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static CredentialsGetAllCredential? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "CredentialsGetAllCredential[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "CredentialsGetAllCredential[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return CredentialsGetAllCredential(
  ...
  static List<CredentialsGetAllCredential> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <CredentialsGetAllCredential>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = CredentialsGetAllCredential.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, CredentialsGetAllCredential> mapFromJson(dynamic json) {
    final map = <String, CredentialsGetAllCredential>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = CredentialsGetAllCredential.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of CredentialsGetAllCredential-objects as value to a dart map
  static Map<String, List<CredentialsGetAllCredential>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<CredentialsGetAllCredential>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = CredentialsGetAllCredential.listFromJson(
          entry.value,
          growable: growable,
        );
      }
