...
// tests for AuthenticationRefreshRefreshToken
void main() {
  // final instance = AuthenticationRefreshRefreshToken();

  group('test AuthenticationRefreshRefreshToken', () {
    ...
    // int expiryTimestamp
    test('to test the property `expiryTimestamp`', () async {
      // TODO
    });
  });
}
