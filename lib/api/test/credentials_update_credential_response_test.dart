...
// tests for CredentialsUpdateCredentialResponse
void main() {
  // final instance = CredentialsUpdateCredentialResponse();

  group('test CredentialsUpdateCredentialResponse', () {
    ...
    // String passwordSalt
    test('to test the property `passwordSalt`', () async {
      // TODO
    });
    ...
    // String usernameSalt
    test('to test the property `usernameSalt`', () async {
      // TODO
    });
    ...
    // String folderUuid
    test('to test the property `folderUuid`', () async {
      // TODO
    });
    ...
    test('to test the property `changedTimestamp`', () async {
      // TODO
    });
