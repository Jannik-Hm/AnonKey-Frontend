...
*AuthenticationApi* | [**authenticationLogoutDelete**](doc//AuthenticationApi.md#authenticationlogoutdelete) | **DELETE** /authentication/logout | Invalidates an access token for user logout.
